%   Function: compute_robustsampsonaml_estimates_custom
%
...
function [listOfEstimatedH, diagnostic] = ...
                            compute_robustsampsonaml_estimates_custom(...
    ...
    listOfNormalisedInitialH{1} = H1;
    inliers1view1 = z(:,inliers);
    inliers1view2 = zp(:,inliers);
    sceneDataJointlyNormalised(1).ptsInViewOne = inliers1view1;
    sceneDataJointlyNormalised(1).ptsInViewTwo = inliers1view2;
    ...
    sceneDataJointlyNormalised(2).ptsInViewOne = inliers2view1;
    sceneDataJointlyNormalised(2).ptsInViewTwo = inliers2view2;
    listOfNormalisedInitialH{2} = H2;
    ...
    for i = 1:length(sceneDataJointlyNormalised)
        ...
        totalNumberOfDataPoints = ...
         ...
         sceneDataJointlyNormalised(i).ptsInViewOne = ...
               T * sceneDataJointlyNormalised(i).ptsInViewOne;
        sceneDataJointlyNormalised(i).ptsInViewTwo = ...
               Tp * sceneDataJointlyNormalised(i).ptsInViewTwo;
